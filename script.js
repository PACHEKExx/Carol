    ...
    const nameOnCake = urlParams.get('nombre') || "Carol";
    const age = urlParams.get('edad') || "25";

    // MODIFICAR: Texto principal que se escribe solo.
    const textToType = "¡Feliz Cumpleaños!";
    ...
    function createBalloons(count) {
        ...
        const niceMessages = [
            ...
            "¡Te queremos!", "¡Felicidades!", "¡A celebrar!", "¡Pura magia!"
        ];
